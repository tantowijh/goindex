self.props = {
  ...
  // https://github.com/tantowijh/goindex/tree/production/themes
...
(function () {
  ...
  async function onGet(request) {
    ...
    if (path.startsWith('/~_~_goindex/resources/')) {
      ...
      const r = await fetch(`https://raw.githubusercontent.com/tantowijh/goindex/production/themes/material-vue-${self.props.ui}/${remain}`);
