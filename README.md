...
Dark Mode : [index.js](https://github.com/tantowijh/goindex/blob/production/goindex-acrou/go2index/index.js)

Copy the [index.js](https://github.com/tantowijh/goindex/blob/production/goindex-acrou/go2index/index.js) script to [workers.dev](https://workers.dev) and edit `client_id`, `client_secret`, `refresh_token` with yours
